...
class MQTTParser {
  ...
  public:
    ...
    void createAction(const uint8_t led_count) {
      ...
      char SolidAction[] = "SOLI";
      char GradientAction[] = "GRAD";
      char MovingGradientAction[] = "MGRD";
      char ClearAction[] = "CLEA";
      char PointAction[] = "PONT";
      char OTA_Update_Action[] = "UDPA";
      ...
      else  if (cstrcmp(OTA_Update_Action, actionKey)) {
        Serial.println("UPDATE REQUEST PROCESSED");
